...
app.use("/routes/showavailability",showavailability);
var bookcar= require(path.join(__dirname,'/routes/bookcar.js'));
app.use('/routes',bookcar);
var returncar= require(path.join(__dirname,'/routes/returncar.js'));
app.use("/routes/returncar",returncar);
